...
import strip.config.SecurityConfiguration;
import strip.config.SecurityJwtConfiguration;
import strip.config.WebConfigurer;
import strip.management.SecurityMetersService;
import strip.web.rest.AuthenticateController;
