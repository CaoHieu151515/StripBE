...
import strip.security.*;
import strip.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/swagger-resources/**")).permitAll() // Tài nguyên Swagger
                    .requestMatchers(mvc.pattern("/webjars/**")).permitAll() // Static assets
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/authenticate")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/authenticate")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/getme")).permitAll()
                    .requestMatchers(mvc.pattern("/api/register")).permitAll()
                    .requestMatchers(mvc.pattern("/api/activate")).permitAll()
                    .requestMatchers(mvc.pattern("/api/send-otp")).permitAll()
