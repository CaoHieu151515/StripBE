...
public class Passenger implements Serializable {
    ...
    @Column(name = "passenger_id", length = 36)
    ...
    public Passenger passengerID(UUID passengerID) {
    ...
    public Passenger startLoca(String startLoca) {
    ...
    public Passenger endLoca(String endLoca) {
    ...
    public Passenger amountApproveFee(Double amountApproveFee) {
    ...
    public Passenger luggageImg(byte[] luggageImg) {
    ...
    public Passenger luggageImgContentType(String luggageImgContentType) {
    ...
    public Passenger luggageDescription(String luggageDescription) {
    ...
    public Passenger type(PassengerType type) {
        this.setType(type);
        return this;
    }
    ...
    public Passenger status(PassengerStatus status) {
    ...
    public Passenger pickUpTime(Instant pickUpTime) {
    ...
    public Passenger endTime(Instant endTime) {
    ...
    public Passenger checkIn(Boolean checkIn) {
    ...
    public Passenger checkInTime(Instant checkInTime) {
    ...
    public Passenger checkOut(Boolean checkOut) {
    ...
    public Passenger checkOutTIme(Instant checkOutTIme) {
    ...
    public Passenger appliedAt(Instant appliedAt) {
