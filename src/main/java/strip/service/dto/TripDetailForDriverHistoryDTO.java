...
public class TripDetailForDriverHistoryDTO {
    ...
    private Set<RequestTripCusDTO> request;
    ...
    public Set<RequestTripCusDTO> getRequest() {
        return request;
    }

    public void setRequest(Set<RequestTripCusDTO> request) {
