  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sTripBeApp.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="sTripBeApp.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sTripBeApp.notification.date')}
              ...
              />
              <ValidatedField
                label={translate('sTripBeApp.notification.content')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('sTripBeApp.notification.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
