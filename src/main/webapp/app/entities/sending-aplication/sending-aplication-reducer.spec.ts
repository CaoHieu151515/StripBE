...
import reducer, {
  ...
  reset,
  updateEntity,
} from './sending-aplication.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENDINGAPLICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SENDINGAPLICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SENDINGAPLICATION actions', async () => {
      const arg = { id: 28238 };
    ...
    it('dispatches UPDATE_SENDINGAPLICATION actions', async () => {
      const arg = { id: 28238 };
    ...
    it('dispatches PARTIAL_UPDATE_SENDINGAPLICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SENDINGAPLICATION actions', async () => {
      const arg = 42666;
