...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGEDRIVER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PACKAGEDRIVER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PACKAGEDRIVER actions', async () => {
      const arg = { id: 17974 };
    ...
    it('dispatches UPDATE_PACKAGEDRIVER actions', async () => {
      const arg = { id: 17974 };
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGEDRIVER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PACKAGEDRIVER actions', async () => {
      const arg = 42666;
