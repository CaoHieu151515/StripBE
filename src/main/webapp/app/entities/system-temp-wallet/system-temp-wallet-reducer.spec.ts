...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMTEMPWALLET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMTEMPWALLET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMTEMPWALLET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMTEMPWALLET actions', async () => {
      const arg = 42666;
