...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDETAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERDETAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERDETAIL actions', async () => {
      const arg = { id: 23168 };
    ...
    it('dispatches UPDATE_USERDETAIL actions', async () => {
      const arg = { id: 23168 };
    ...
    it('dispatches PARTIAL_UPDATE_USERDETAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERDETAIL actions', async () => {
      const arg = 42666;
