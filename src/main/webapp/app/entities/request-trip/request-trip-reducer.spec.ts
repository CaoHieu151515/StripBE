...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTTRIP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REQUESTTRIP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTTRIP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REQUESTTRIP actions', async () => {
      const arg = 42666;
