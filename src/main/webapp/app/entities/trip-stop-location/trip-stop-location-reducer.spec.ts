...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './trip-stop-location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIPSTOPLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIPSTOPLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIPSTOPLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRIPSTOPLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRIPSTOPLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRIPSTOPLOCATION actions', async () => {
      const arg = 42666;
