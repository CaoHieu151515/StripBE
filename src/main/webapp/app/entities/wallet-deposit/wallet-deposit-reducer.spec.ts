...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WALLETDEPOSIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WALLETDEPOSIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WALLETDEPOSIT actions', async () => {
      const arg = { id: '98cc36ca-90c4-4ed3-ab46-7acd0649ca7c' };
    ...
    it('dispatches UPDATE_WALLETDEPOSIT actions', async () => {
      const arg = { id: '98cc36ca-90c4-4ed3-ab46-7acd0649ca7c' };
    ...
    it('dispatches PARTIAL_UPDATE_WALLETDEPOSIT actions', async () => {
    ...
    it('dispatches DELETE_WALLETDEPOSIT actions', async () => {
      const arg = 42666;
