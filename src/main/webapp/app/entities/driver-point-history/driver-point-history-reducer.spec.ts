...
import reducer, {
  ...
  reset,
  updateEntity,
} from './driver-point-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRIVERPOINTHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRIVERPOINTHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRIVERPOINTHISTORY actions', async () => {
      const arg = { id: 14702 };
    ...
    it('dispatches UPDATE_DRIVERPOINTHISTORY actions', async () => {
      const arg = { id: 14702 };
    ...
    it('dispatches PARTIAL_UPDATE_DRIVERPOINTHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRIVERPOINTHISTORY actions', async () => {
      const arg = 42666;
