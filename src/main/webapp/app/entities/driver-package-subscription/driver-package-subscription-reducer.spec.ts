...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRIVERPACKAGESUBSCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRIVERPACKAGESUBSCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_DRIVERPACKAGESUBSCRIPTION actions', async () => {
    ...
    it('dispatches DELETE_DRIVERPACKAGESUBSCRIPTION actions', async () => {
      const arg = 42666;
