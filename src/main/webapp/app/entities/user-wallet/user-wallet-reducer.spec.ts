...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERWALLET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERWALLET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERWALLET actions', async () => {
      const arg = { id: 6166 };
    ...
    it('dispatches UPDATE_USERWALLET actions', async () => {
      const arg = { id: 6166 };
    ...
    it('dispatches PARTIAL_UPDATE_USERWALLET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERWALLET actions', async () => {
      const arg = 42666;
