...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMWALLET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMWALLET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSTEMWALLET actions', async () => {
      const arg = { id: 6859 };
    ...
    it('dispatches UPDATE_SYSTEMWALLET actions', async () => {
      const arg = { id: 6859 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMWALLET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMWALLET actions', async () => {
      const arg = 42666;
