...
public class TripFindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find); // Update with your actual XML file name
        ...
        btnFindDrivers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TripFindActivity.this, TripPublishActivity.class);
    ...
    private void showRouteOnMap() {
        ...
        new TripFindActivity.GetRouteTask().execute(routeUrl);
    }
            ...
            if (result != null) {
                try {
                    ...
                    if (routes != null && routes.length() > 0) {
                        ...
                        Toast.makeText(TripFindActivity.this, "Distance: " + distance + " km\nDuration: " + duration + " min", Toast.LENGTH_LONG).show();

                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    Log.e("Error", "Failed to get route " + e);
                    Toast.makeText(TripFindActivity.this, "Failed to parse route", Toast.LENGTH_SHORT).show();
                }
            } else {
                Log.e("Error", "Failed to get route " + result);
                Toast.makeText(TripFindActivity.this, "Failed to get route", Toast.LENGTH_SHORT).show();
            }
        }
    }
