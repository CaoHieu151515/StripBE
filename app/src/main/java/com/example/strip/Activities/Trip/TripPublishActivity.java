...
public class TripPublishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publish); // Update with your actual XML file name
        ...
        btnOrderNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TripPublishActivity.this, TripPickActivity.class);
    ...
    private void showRouteOnMap() {
        ...
        new TripPublishActivity.GetRouteTask().execute(routeUrl);
    }
            ...
            if (result != null) {
                try {
                    ...
                    if (routes != null && routes.length() > 0) {
                        ...
                        Toast.makeText(TripPublishActivity.this, "Distance: " + distance + " km\nDuration: " + duration + " min", Toast.LENGTH_LONG).show();

                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    Log.e("Error", "Failed to get route " + e);
                    Toast.makeText(TripPublishActivity.this, "Failed to parse route", Toast.LENGTH_SHORT).show();
                }
            } else {
                Log.e("Error", "Failed to get route " + result);
                Toast.makeText(TripPublishActivity.this, "Failed to get route", Toast.LENGTH_SHORT).show();
            }
        }
    }
