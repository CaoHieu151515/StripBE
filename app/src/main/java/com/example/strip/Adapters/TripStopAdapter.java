...
public class TripStopAdapter extends RecyclerView.Adapter<TripStopAdapter.TripStopViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TripStopViewHolder holder, int position) {
        ...
        holder.tvStopLocaTime.setText(stopLocation.getStopLocaTime());
        holder.tvStopLoca.setText(stopLocation.getStopLoca());
        holder.tvStopLocaStatus.setText(stopLocation.getStopLocaStatus());
        holder.tvEstimatedTime.setText("Time: " + stopLocation.getEstimatedTime());
        holder.tvEstimatedKM.setText("Distance: " + stopLocation.getEstimatedKM());
    ...
    public static class TripStopViewHolder extends RecyclerView.ViewHolder {
        TextView tvStopLocaTime, tvStopLoca, tvStopLocaStatus, tvEstimatedTime, tvEstimatedKM;
