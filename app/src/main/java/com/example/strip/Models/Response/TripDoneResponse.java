...
public class TripDoneResponse {
    ...
    public List<StopLocationDoneResponse> getStopLocationDoneResponseList() {
        return stopLocationDoneResponseList;
    }

    public void setStopLocationDoneResponseList(List<StopLocationDoneResponse> stopLocationDoneResponseList) {
        this.stopLocationDoneResponseList = stopLocationDoneResponseList;
    }
}
